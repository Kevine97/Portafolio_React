...
const About = () => {
  // const author = "https://i.ibb.co/HXFMWfD/Kevin-2.png";
  ...
  return (
    <div className="container py-5 mb-5" id="about">
      <div className="row d-flex justify-content-center align-items-center">
        <div className="col-lg-5 col-xm-12 mt-3">
        ...
        <div className="col-lg-7 col-xm-12 col-md-12 heading-section ftco-animate">
          <h2 className="sobremi font-weight-bold colorTexto text-center text-uppercase">
            Sobre mí
          </h2>
          <div className="line-mf mb-4 mb-md-4"></div>
          <div className="count-box">
            <p className="about-text font-about mb-5">
              Soy un joven autodidacta y con gran pasión por el
              desarrollo de software. Soy capaz de adaptarme a cualquier
